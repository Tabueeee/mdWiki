# G:/dev/01_projects/mdWiki/client/src/component/nav-menu/menu-template.html
```js
        ...
        <ul class="menu-list" data-bind="foreach: entries">
            <li>
                ...
                <ul data-bind="visible: !collapsed, foreach: items">
                    <li>
                        <a data-bind="click: $root.changePage.bind(null, url), text: topic, css: {'is-active': $root.currentUrl() == url}"></a>
                    </li>
                </ul>
            </li>
        </ul>
