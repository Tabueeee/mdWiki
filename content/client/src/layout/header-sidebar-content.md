...
<head>
    ...
    <link rel="preload" href="/mousetrap.js" as="script">
    ...
    <style type="text/css">
        {% include '../../dist/critical.min.css' ignore missing %}
    </style>

    {% include '../component/templates.twig' %}
</head>

<body>
<header class="navbar is-primary" role="navigation" aria-label="main navigation">
    {% include '../component/header/header-template.twig' %}
</header>
...
<footer class="footer">
    <div class="content has-text-centered">
        <p><strong>MD-Wiki</strong>.</p>
    </div>
</footer>
<search-popup>
    {% include '../component/search-popup/search-popup.html' %}
</search-popup>

<script>
    (function (document) {
        var styleElement = document.createElement('link');
        styleElement.src = '/style{{ assetUID }}.css';
